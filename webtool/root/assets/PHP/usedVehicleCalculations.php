<?php 
    ...
    function calculateSimpleDepreciationUsed($numYears)
    {
...
function calculateAdvancedExponentialDepreciationUsed($numYears)
{
    include "connectDatabase.php";
    ...
    function calculateUsedBodyCost()
    {
        ...
        {
            $depreciationCost = calculateSimpleDepreciationUsed(5, $modelYear);
        }
        else
        {
            $depreciationCost = calculateAdvancedExponentialDepreciationUsed(5, $modelYear);
        }
    ...
    function calculateExtraChargingTimeUsed($numYears)
    {
        include "getID.php";
        $totalCost;
    ...
    function calculateNewLaborCostUsed()
    {
        include "connectDatabase.php";
        $totalCost;
        $extraPayload;
        ...
        $chargingTime = calculateExtraChargingTimeUsed($numYears);
    ...
    function calculateExtraPayloadCostUsed($numYears)
    {
        include "connectDatabase.php";
    ...
    function calculateDowntimeOppurtunityCostUsed($numYears)
    {
        include "connectDatabase.php";
    ...
    function calculateUsedOperationalCost()
    {
        ...
        $vehicle = calculateUsedBodyCost();
        $financeCost = calculateUsedFinancingCost();
        $annualFuelCost = calculateUsedFuelCost();
        $insuranceCost = calculateUsedInsuranceCost();
        $taxesAndFees = calculateUsedTaxesCost();
        $maintenance = calculateUsedMaintenance();
        $labor = calculateNewLaborCostUsed();
        ...
        $extraPayLoad = calculateExtraPayloadCostUsed($analysisWindow);
        $downTimeOpprutunity = calculateDowntimeOppurtunityCostUsed($analysisWindow);
