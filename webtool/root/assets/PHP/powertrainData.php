...
function calculateAdvancedExponentialDepreciationPowertrain($numYears, $powertrainType)
{
    ...
    function calculateExtraPayloadCostPowertrain($numYears, $powertrain)
    {
        include "connectDatabase.php";
    ...
    function calculateDowntimeOppurtunityCostPowertrain($numYears, $powertrain)
    {
        include "connectDatabase.php";
    ...
    function calculateOperationalCostPowertrain($powertrain)
    {
        include "connectDatabase.php";
        ...
        $vehicle = calculateBodyCostPowertrain($powertrain);
        $financeCost = calculateFinancingCost($powertrain);
        $annualFuelCost = calculateFuelCost($powertrain);
        $insuranceCost = calculateInsruance($powertrain);
        $taxesAndFees = calculateTaxes($powertrain);
        $maintenance = calculateMaintenance($powertrain);
        $labor = calculateNewLaborCostPowertrain($powertrain);
        ...
        $extraPayLoad = calculateExtraPayloadCostPowertrain($analysisWindow, $powertrain);
        $downTimeOpprutunity = calculateDowntimeOppurtunityCostPowertrain($analysisWindow, $powertrain);
